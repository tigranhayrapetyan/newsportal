  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">News Portal</span>
                </a>
              </div>
            </div>
            @if(session('success'))
    ...
    @endif
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2022 Copyright by TH 
          <a class="text-primary" href="mailto:tigrannhayrapetyan@gmail.com" target="_blank">Send Email</a>.
        </p>
      </div>
    </div>
</body>
